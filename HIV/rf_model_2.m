...
features_select_a = zeros(reps*cv_folds,n_features);
features_select_b = zeros(reps*cv_folds,n_features);
...
for j=1:reps
    ...
    for i=1:cv_folds
        ...
        imp_a = mdl_a.OOBPermutedPredictorDeltaError;
        features_select_a(count,:) = imp_a;
        
        imp_b = mdl_b.OOBPermutedPredictorDeltaError;
        features_select_b(count,:) = imp_b;
